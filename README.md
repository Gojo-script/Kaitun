...
local listfastattack = {'Normal Attack','Fast Attack','Super Fast Attack','Ultra Attack,'Galaxy🪐 Attack}
	...
	elseif _G.FastAttackFaiFao_Mode == "Super Fast Attack" then
		_G.Fast_Delay = 0.05
        elseif _G.FastAttackFaiFao_Mode == "Ultra Atack" then
		_G.Fast_Delay = 0.01
        elseif _G.FastAttackFaiFao_Mode == "Galaxy🪐 Attack" then
		_G.Fast_Delay = 0
