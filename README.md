...
local ToggleButton = Instance.new("Jay Hub⚡")
...
local listfastattack = {'Normal Attack','Fast Attack','Super Fast Attack','Jay Hub⚡ Atack'}
	...
	elseif _G.FastAttackFaiFao_Mode == "Super Fast Attack" then
		_G.Fast_Delay = 0.05
  elseif _G.FastAttackFaiFao_Mode == "Jay Hub⚡ Atack" then
		_G.Fast_Delay = 0.1
	end
end)
